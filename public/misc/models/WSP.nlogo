...
to export-to [root-url]
  ...
  let run-id-tuple    ["run_id"    "grapes"]
  ...
  let work-params   (list period-id-tuple user-id-tuple run-id-tuple work-meta-tuple work-desc-tuple)
  let work-response web:export-world work-url work-method work-params
  
  let extras-ref-id-tuple (list "ref_id"   (first work-response))
  let extras-meta-tuple        ["metadata" "{ \"type\": \"export_view\" }"]
  
  let extras-url      (word root-url "-supplement")
  let extras-method   "POST"
  let extras-params   (list extras-ref-id-tuple extras-meta-tuple)
  let extras-response web:export-view extras-url extras-method extras-params
